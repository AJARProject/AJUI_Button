//%attributes = {}
  // HDI_ToggleBtn_call ( param1 ) 
  //
  // param1 : (boolean) (optional) to launch the new process
  //
  // Execute the form HDI_ToggleBtn
...
Else 
	...
	$winRef_l:=Open form window:C675("HDI_ToggleBtn";Plain form window:K39:10;On the left:K39:2;At the top:K39:5)
	DIALOG:C40("HDI_ToggleBtn")
